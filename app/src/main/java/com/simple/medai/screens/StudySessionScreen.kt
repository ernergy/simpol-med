...
fun StudySessionScreen(
    ...
    var attachment by remember {
        mutableStateOf<AiAttachment?>(null)
    }
    ...
    var previousResponseId by remember {
        mutableStateOf<String?>(null)
    }

    var activeVectorStoreId by remember {
        mutableStateOf<String?>(null)
    }

    var lastArtifactType by remember {
        mutableStateOf<String?>(null)
    }
    ...
    var exportIndex by remember {
        mutableStateOf<Int?>(null)
    }

    var pendingFile by remember {
        mutableStateOf<GeneratedFile?>(null)
    }
    ...
    Surface(
        ...
        Column(
            ...
            SimpleHeader(
                "SIMPLE IA",
                "Pregunta naturalmente • adjunta • descarga"
            )
                                ...
                                ) {
                                    {
                                        scope.launch {
                                            ...
                                            try {
                                                ...
                                                errorText =
                                                    e.message
                                                        ?: "No se pudo crear el PowerPoint."
                                            } finally {
                                                exportIndex =
                                                    null
                                            }
            ...
            Card(
                ...
                Column(
                    ...
                    Text(
                        "Archivos grandes se preparan automáticamente para análisis. No necesitas dividirlos manualmente.",
                        fontSize = 10.sp,
                        color =
                            MaterialTheme
                                .colorScheme
